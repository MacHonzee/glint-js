...
import { UseCaseEnvironment, Session, AuthorizationResult } from "glint-js-core";
...
class TestService {
  ...
  async getUcEnv(useCase, data = {}, user, authorizedRoles = []) {
    ...
    ucEnv.authorizationResult = new AuthorizationResult({
      ...
      useCaseRoles: [], // TODO check whether we need RouteRegister.getRoute(useCase)?.roles somewhere
